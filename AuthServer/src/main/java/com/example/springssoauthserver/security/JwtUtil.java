...
public class JwtUtil {
    ...
    public static String generateToken(String subject, int validDuration,String email,int id, int isHr) {
...
//            String email = claims.get("email").toString();
    ...
    public static String getSubjectFromJwtRegistration(String token) {
        try {
            String subject = Jwts.parser().setSigningKey(JwtConstant.REGISTRATION_SIGNING_KEY)
                    .parseClaimsJws(token)
                    .getBody()
                    .getSubject();
